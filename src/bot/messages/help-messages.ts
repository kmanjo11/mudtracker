export class HelpMessages {
  static generalHelp = `
How to use <b>MUD TRACKER Bot: </b>
...
/upgrade - Upgrade your MUD TRACKER plan

🆘 Help Commands:
/help_notify - How to use MUD TRACKER notifications
/help_group - How to add MUD TRACKER to group chats
`

  static groupsHelp = `
<b>How to add MUD TRACKER to Telegram groups:</b>

1️⃣ Add MUD TRACKER as an administrator in your Group chat
...
`
  ...
  static notifyHelp = `
<b>How to use MUD TRACKER Bot:</b>
1️⃣ Send /start
2️⃣ Click on <b>Add</b> Button
3️⃣ Paste the address you want to track

<b>Understand MUD TRACKER notifications:</b>
<b>@</b> - Token Price
